...
Build a tool using Beautiful Soup library in Python to extract the first 100 contributors response json from the API https://api.github.com/repos/apache/hadoop/contributors which contains hadoop github repo contributors’ urls endpoint.
